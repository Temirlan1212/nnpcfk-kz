  ...
  return (
    <div className={`card ${className}`}>
      ...
      <div className={`card-header border-0 py-5 bg-${chartColor}`}>
        <div>
          <h3 className="card-title fw-bold text-white">Обо мне</h3>
          <span className="text-light fw-semibold d-block">
            Ваша деятельность на платформе
          </span>
        </div>
        ...
        <div className="card-p mt-n20 position-relative">
          ...
          <div className="row g-0">
            ...
            <div className="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
              ...
              />
              <a href="#" className="text-warning fw-semibold fs-1">
                6
              </a>
            ...
            <div className="col bg-light-primary px-6 py-8 rounded-2 mb-7">
              ...
              <a href="#" className="text-primary fw-semibold fs-1">
                37
              </a>
              <span className="text-primary fw-semibold d-block">Курсов</span>
            </div>
            {/* end::Col */}
          </div>
          {/* end::Row */}
          ...
          <div className="row g-0">
            ...
            <div className="col bg-light-danger px-6 py-8 rounded-2 me-7">
              ...
              />
              <a href="#" className="text-danger fw-semibold fs-1">
                822
              </a>
            ...
            <div className="col bg-light-success px-6 py-8 rounded-2">
              ...
              />
              <a href="#" className="text-success fw-semibold fs-1">
                41
              </a>
