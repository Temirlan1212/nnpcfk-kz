        ...
        <div className='card mb-5 mb-xl-10'>
            ...
            <div id='kt_account_profile_details' className='collapse show'>
                <div className='card-body border-top p-9'>
                    ...
                    <div className="row mb-6">
                        <label className="col-lg-4 col-form-label required fw-bold fs-6">БИН</label>
                    ...
                    <div className="row mb-6">
                        <label className="col-lg-4 col-form-label required fw-bold fs-6">Наименование школы</label>
                        <div className="col-lg-8 fv-row">
                            <input type="text"
                                   className="form-control form-control-lg form-control-solid"
                    ...
                    <div className="row mb-6">
                        <label className="col-lg-4 col-form-label required fw-bold fs-6">Проектная мощность</label>
                        <div className="col-lg-8 fv-row">
                            <input type="text"
                                   className="form-control form-control-lg form-control-solid"
                                   placeholder="1000"
                    ...
                    <div className="row mb-6">
                        <label className="col-lg-4 col-form-label required fw-bold fs-6">Фактическое количество
                            учащихся</label>
                        <div className="col-lg-8 fv-row">
                            <input type="text"
                                   className="form-control form-control-lg form-control-solid"
                    ...
                    <div className="row mb-6"><label className="col-lg-4 col-form-label fw-bold fs-6"><span
                        className="required">Тип</span></label>
            ...
            <div id='kt_account_profile_details' className='collapse show'>
                <div className='card-body border-top p-9'>
                    ...
                    <div className="row mb-6">
                        <label className="col-lg-4 col-form-label required fw-bold fs-6">Площадь, кв.м. </label>
                        <div className="col-lg-8 fv-row">
                            <input type="text"
                                   className="form-control form-control-lg form-control-solid"
                                   placeholder="45,3"
            ...
            <div id='kt_account_profile_details' className='collapse show'>
                <div className='card-body border-top p-9'>
                    ...
                    <div className="row mb-6"><label className="col-lg-4 col-form-label fw-bold fs-6"><span
                        className="required">Покрытие</span></label>
                        <div className="col-lg-8 fv-row"><select
                            className="form-select form-select-solid form-select-lg" name="type">
                    ...
                    <div className='mb-6'>
                        ...
                        <div className='row mb-6'>
                            ...
                            <div className='col-lg-5'>
                                <label className="col-lg-8 col-form-label required fw-bold fs-6">Тип площадки</label>
                            ...
                            <div className='col-lg-5'>
                                <label className="col-lg-8 col-form-label required fw-bold fs-6">Размер</label>
                                <div className="col-lg-12 fv-row">
                                    <select
                                        className="form-select form-select-solid form-select-lg" name="type">
                        ...
                        <button type="submit" className="btn btn-secondary mt-3">Добавить площадку</button>
            ...
            <div id='kt_account_profile_details' className='collapse show'>
                <div className='card-body border-top p-9'>
                    ...
                    <div className="card mb-5 mb-xl-8">
                        <div className="d-flex justify-content-between align-items-center flex-wrap mb-2" style={{
                            minHeight: '70px',
                            padding: '0 2.25rem'
                        }}>
                        ...
                        <div className="card-body py-3">
                            <div className="table-responsive">
                                <table className="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                    ...
                                    <tr>
                                        <td>
                                            <div className="text-gray-600 fw-bold fs-6">Айдар Нурмагамбетов</div>
                                        </td>
                                        <td>
                                            <div className="text-gray-600 fw-bold fs-6">+7 777 777 7778</div>
                                        </td>
                                        <td>
                                            <div
                                                className="text-gray-600 fw-bold fs-6">a.amangeldievich@center.nnpcfk.kz
                                            </div>
                                        </td>
                                        <td>
                            ...
                            <div className="table-responsive">
                                <table className="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                className="text-gray-600 fw-bold fs-6">ДЮШС
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div className="text-gray-600 fw-bold fs-6">Баскетбол</div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div
                                                className="text-gray-600 fw-bold fs-6">Дворовой клуб
                                            </div>
                                        </td>
                                        <td>
                    ...
                    <div className='mb-6'>
                        ...
                        <div className='row mb-6'>
                            ...
                            <div className='col-lg-11 row'>
                                ...
                                <div className='col-lg-3'>
                                    <label className="col-lg-8 pt-0 col-form-label required fw-bold fs-6">Класс</label>
                                    <div className="col-lg-12 fv-row">
                                        <div className="col-lg-12 fv-row">
                                            <input type="text"
                                                   className="form-control form-control-lg form-control-solid"
                                ...
                                <div className='col-lg-3'>
                                    <label
                                        className="col-lg-8 pt-0 col-form-label required fw-bold fs-6">Количество</label>
                                    <div className="col-lg-12 fv-row">
                                        <div className="col-lg-12 fv-row">
                                            <input type="text"
                                                   className="form-control form-control-lg form-control-solid"
                                ...
                                <div className='col-lg-3'>
                                    <label
                                        className="col-lg-8 pt-0 col-form-label required fw-bold fs-6">Победители</label>
                                    <div className="col-lg-12 fv-row">
                                        <input type="text"
                                               className="form-control form-control-lg form-control-solid"
                        ...
                        <div className="card-body py-3">
                            <div className="table-responsive">
                                <table className="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                    ...
                                    <tr>
                                        <td>
                                            <div className="text-gray-600 fw-bold fs-6">Исаева Алия</div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div
                                                className="text-gray-600 fw-bold fs-6">Волейбол
                                            </div>
                                        </td>
                                        <td>
                                            <div className="text-gray-600 fw-bold fs-6">2-й юношеский разряд</div>
                                        </td>
                                        <td>
